...
export const ABIS = {
	...
	"Processor": [
		`function executeOrders(uint256[] orderIds, bytes[] calldata priceUpdateData)`,
		`function liquidatePositions(address[] users, address[] assets, string[] markets, bytes[] calldata priceUpdateData)`,
	].concat(EVENT_ABIS),
	"MarketStore": [
